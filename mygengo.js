...
// var declarations
var mg_public_key, mg_private_key, mg_hmac, mg_callback_functions, api_mygengo, mg_params = {}, mg_qs_params, mg_json_params, production_env;

// Public functions

// initalizes the api. Just passes pub and pri keys.
exports.init = function(pub, pri, callback_functions, production) {
  mg_public_key = pub;
  mg_private_key = pri;
...
exports.getPreviewURL = function(job_id,callback){
  callAPI('GET','/translate/job/'+job_id+'/preview/',callback,'binary',function(mg_response){
	fs.writeFile('public/images/translation_previews/'+job_id+".jpg",mg_response,'binary',function(err){
		if (err) callback(err);
...
function callAPI(method,mg_url,callback,encoding,override){
  ...
  mg_json_params = JSON.stringify(mg_params);
